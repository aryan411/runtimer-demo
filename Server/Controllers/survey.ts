...
export function getSurveys(req:any, res:any, next:any) {
  const promises :any[] = [];
  Survey.find((err:any, surveys: any[]) => {
    if (err) {
      ...
      const filteredSurveys = surveys.filter((survey: { user: any; }) => survey.user);
      ...
      filteredSurveys.forEach((survey: { user: any; }, i: any) => {
        ...
        const promise = User.findById({"_id": survey.user}, (err: any, foundUser: any) => {
          if (err) {
            console.error(err);
          }
         }).exec();
      ...
      Promise.all(promises).then((values:any) => {
        ...
        filteredSurveys.forEach((survey: { _doc: any; }, index: string | number) => {
...
export function getSurvey(req: { params: { id: any; }; }, res: { end: (arg0: any) => void; json: (arg0: { error: any; data: any; }) => void; }, next: any){
...
export function addSurvey(req: { body: { user: any; name: any; dateCreated: any; dateActive: any; dateExpire: any; responses: any; questions: any; }; }, res: { end: (arg0: any) => void; json: (arg0: { error: any; data: any; }) => void; }, next: any){
...
export function updateSurvey(req: { params: { id: any; }; body: { userID: any; survey: { user: any; name: any; dateCreated: any; dateActive: any; dateExpire: any; responses: any; questions: any; }; }; }, res: { end: (arg0: any) => void; json: (arg0: { error: any; }) => void; }, next: any) {
...
export function takeSurvey(req: { params: { id: any; }; body: { questions: any; }; }, res: { end: (arg0: any) => void; json: (arg0: { error: any; }) => void; }, next: any){
  let id = req.params.id
  // bellow stores questions with responses
  let updatedQuestions =  req.body.questions;

  Survey.findById({"_id": id},
   (err: any, survey: { responses: number; questions: any[]; save: () => void; }) => {
      if (err) {
        console.error(err);
        res.end(err);
      } else 
...
export function deleteSurvey(req: { body: { survey: { _id: any; user: any; }; userID: any; }; }, res: { end: (arg0: any) => void; json: (arg0: { error: any; }) => void; }, next: any){
