...
exports.deleteSurvey = exports.takeSurvey = exports.updateSurvey = exports.addSurvey = exports.getSurvey = exports.getSurveys = void 0;
        ...
        if (err) {
            ...
            Promise.all(promises).then((values) => {
                ...
                filteredSurveys.forEach((survey, index) => {
                    surveysToReturn.push(Object.assign(Object.assign({}, survey._doc), { displayName: values[index].displayName }));
                });
